...
;; NOTE: If you want smart complete enable this alongside company mode.
...
;; Make scratch use org-mode
(setq initial-major-mode 'org-mode)
(setq initial-scratch-message "#+TITLE: Scratch\n\n")

;; Define dir for daily journals
(setq org-journal-dir "~/org/journal/")

;; Function for building today's journal file name
(defun get-journal-file-today ()
  "Return filename for today's journal entry."
  (let ((daily-name (format-time-string "%Y%m%d.org")))
    (expand-file-name daily-name org-journal-dir)))

;; Adding templates to org-capture
(after! org
